...
class Player:
    ...
    def collision(self,b):
        ...
        if b.type == 'wall':
            return b.x-15 < self.x < b.x+b.w+15 and \
                    b.y-15 < self.y < b.y+b.h+15
...
def setup():
    ...
    walls.append(Block(185,0,30,250,'wall'))
    walls.append(Block(385,200,30,250,'wall'))
    walls.append(Block(585,0,30,250,'wall'))
